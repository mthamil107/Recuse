...
\emph{noticing}: an in-band halt was acknowledged in only 1/20 trials versus
...
An in-band halt was acknowledged in only 1/20 trials; the same halt in the prompt
