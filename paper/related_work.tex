...
specifically at autonomous web agents is only just emerging. Most directly,
\citet{marro2026permission} propose \emph{permission manifests} (an
\texttt{agent-permissions.json} file) that let sites declare which agent
interactions are permitted, echoing our motivation. Recuse differs along two axes
that constitute our core contribution. First, mechanism: we standardize an
